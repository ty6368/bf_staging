package com.sentaca.rest.client;
...
public class RestClient 
{
	...
	{	
		...
		case POST:
			...
			{
				if (!httpContentType.getSubtype().equalsIgnoreCase("mixed")) {
					System.out.println("second case");
					clientResponse = service.queryParams(parameters).header("Content-Type", "multipart/form-data; type=\"application/x-www-form-urlencoded\"; start=\"<startpart>\"; boundary=\"foo\"").accept(httpAcceptType).post(ClientResponse.class, requestBody);
				}
				else {
					System.out.println("third case");
					clientResponse = service.queryParams(parameters).header("Content-Type", "multipart/mixed").accept(httpAcceptType).post(ClientResponse.class, requestBody);
				}
